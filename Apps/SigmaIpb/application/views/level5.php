...
<html>
	<head>
		...
		<script defer="defer" type="text/javascript">
			function init(){
				var bounds = new OpenLayers.Bounds(11880112,-731918.3125,11881295,-731519.0625);
                ...
                wing = new OpenLayers.Layer.WMS(
					"ipb_gis:level5 - Tiled", "http://localhost:8080/geoserver/ipb_gis/wms",
					{
						LAYERS: 'ipb_gis:level5',
						STYLES: '',
						transparent: "true",
						format: format,
					},
				...
				base = new OpenLayers.Layer.WMS(
					"ipb_gis:level5base - Untiled", "http://localhost:8080/geoserver/ipb_gis/wms",
					{
						LAYERS: 'ipb_gis:level5base',
						STYLES: '',
						transparent: "true",
						format: format,
					},
			...
			function filter_wing(){
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url()?>index.php/map/marker5',
			...
			<div id="header">
				...
				<div id="nav-top">
					<ul>
						...
						<?php } ?>
						<a style="color:red;" href="<?php echo base_url().'map/level5'?>">
				...
				<div class="left-col">
					<div id="welcome">
						...
						<table width="" border="0" cellpadding="7" align="center">
							...
							?>
							<form method="post" action='<?PHP echo site_url("map/marker5")?>'>
								<tr>
									<td width="">
										<?php
							...
							<?php } else { ?>
							<tr>
								<td>Hasil pencarian <?php echo $_SESSION['katakunci']; ?> di Level 5</td>
								<td><a href="<?php echo base_url('map/reset_cari5'); ?>">Cari Lagi</a></td>
							</tr>
							<tr>
