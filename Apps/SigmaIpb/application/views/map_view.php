	 ...
	 <script defer="defer" type="text/javascript"> 
            ...
            function init(){
               ...
               var bounds = new OpenLayers.Bounds(
                    11880113, -731918.3125,
                    11881066, -731519.0625
                );
                var options = {
					minScale: 4261,
                ...
                untiled = new OpenLayers.Layer.WMS(
                    "ipb_gis:level1 - Tiled", "http://localhost:8080/geoserver/ipb_gis/wms",
                    {
                        LAYERS: 'ipb_gis:level1',
                        STYLES: '',
                        format: format,
                    }
                );
...
<div id="wrapper">
  <div id="header">
	...
	<div id="nav-top">
      <ul>
	    <a style="color:#fdfdfd;" href="<?php echo base_url().'map/index'?>">
