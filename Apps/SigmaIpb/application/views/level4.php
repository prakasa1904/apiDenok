...
<html>
	<head>
		...
		<script defer="defer" type="text/javascript">
			function init(){
				var bounds = new OpenLayers.Bounds(11880112,-731903.625,11881295,-731519.1875);
				...
				wing = new OpenLayers.Layer.WMS(
					"ipb_gis:level4 - Tiled", "http://localhost:8080/geoserver/ipb_gis/wms",
					{
						LAYERS: 'ipb_gis:level4',
						STYLES: '',
						transparent: "true",
						format: format,
					},
				...
				base = new OpenLayers.Layer.WMS(
					"ipb_gis:level4base - Untiled", "http://localhost:8080/geoserver/ipb_gis/wms",
					{
						LAYERS: 'ipb_gis:level4base',
						STYLES: '',
						transparent: "true",
						format: format,
					},
			...
			function filter_wing(){
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url()?>index.php/map/marker4',
			...
			<div id="header">
				...
				<div id="nav-top">
					<ul>
						...
						<a style="color:#fdfdfd;" href="<?php echo base_url().'map/level4'?>">
						...
						<?php } ?>
						<?php
						if (isset($_SESSION['jum6'])&&($_SESSION['jum6']>0)){?>
				...
				<div class="left-col">
					<div id="welcome">
						...
						<table width="" border="0" cellpadding="7" align="center">
							...
							?>
							<form method="post" action='<?PHP echo site_url("map/marker4")?>'>
								<tr>
									<td width="">
										<?php
							...
							<?php } else { ?>
							<tr>
								<td>Hasil pencarian <?php echo $_SESSION['katakunci']; ?> di Level 4</td>
								<td><a href="<?php echo base_url('map/reset_cari4'); ?>">Cari Lagi</a></td>
							</tr>
							<tr>
