	 ...
	 <script defer="defer" type="text/javascript"> 
            ...
            function init(){
              ...
              var bounds = new OpenLayers.Bounds(
                   11880112, -731947.0625,
                    11881263, -731518.9375
                );
                var options = {
					minScale: 4261,
                ...
                untiled = new OpenLayers.Layer.WMS(
                     "ipb_gis:level3 - Tiled", "http://localhost:8080/geoserver/ipb_gis/wms",
                    {
                        LAYERS: 'ipb_gis:level3',
                        STYLES: '',
                        format: format,
                    }
                );
  ...
  <div id="header">
	...
	<div id="nav-top">
      <ul>
		...
		<a style="color:#fdfdfd;" href="<?php echo base_url().'map/level3'?>">
