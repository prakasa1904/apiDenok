	...
	<div id="wrapper">
		...
		<div id="isi">
			<div id="content"><br />
				...
				<div class="left-col">
					<div id="welcome"><br />
						<form name="form1" id="form1" action="<?=base_url()?>index.php/map/add" method="post" enctype="multipart/form-data">
							<?php
							...
							<table width="600" border="0">
								<tr>
									<td>Kode Barang</td>
									<td><input size="70" name="kode" type="text" id="kode" value="<?php echo set_value('kode');?>"></td>
								</tr>
								<tr>
									<td>Nama</td>
									<td><input size="70" name="nama" type="text" id="nama" value="<?php echo set_value('nama');?>"></td>
								</tr>
								<tr>
									<td>Merk</td>
									<td><input size="70" name="merk" type="text" id="merk" value="<?php echo set_value('merk');?>"></td>
								</tr>
								<tr>
									<td>Tahun</td>
								...
								<tr>
									<td>Harga Satuan</td>
									<td><input size="70" name="harga" type="text" id="harga" value="<?php echo set_value('harga');?>"></td>
								</tr>
								<tr>
									<td>Sumber Dana</td>
									<td><input size="70" name="dana" type="text" id="dana" value="<?php echo set_value('dana');?>"></td>
								</tr>
								<tr>
									<td>Ruang</td>
									<td>
								...
								<tr>
									<td>Longitude</td>
									<td><input size="70" name="longitude" type="text" id="longitude" value="<?php echo set_value('longitude');?>" readonly></td>
								</tr>
								<tr>
									<td>Latitude</td>
									<td><input size="70" name="latitude" type="text" id="latitude" value="<?php echo set_value('latitude');?>" readonly></td>
								</tr>
								<!-- buka komen
								<tr>
									<td>Kondisi</td>
